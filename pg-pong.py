...
import sys
sys.path.append(r"/Users/homes/opt/anaconda3/lib/python3.9/site-packages")
import gym
import time
...
while True:
  ...
  if done: # an episode finished
    ...
    if running_reward > -16.8:
      ...
      print("End time:", end)
      print("Total number of hours: ", HoursGet)
      print("Total number of mins: ", MinutesGet)
      print("Total number of second: ", SecondsGet)
      sys.exit(('Number of neurons at crash: %d' % (H)))
